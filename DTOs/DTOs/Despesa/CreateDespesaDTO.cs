...
namespace DTO.DTOs.Despesa
{
    ...
    {
        [Required(ErrorMessage = "definir o custo é Obrigatório.")]
        ...
        [Required(ErrorMessage = "definir a quantidade de Dias consumida no Mês é Obrigatório.")]
        [Range(1, 30, ErrorMessage = "Valor deve estar entre 1 e 30")]
        public int DiasNoMes { get; set; }
        [Required(ErrorMessage = "definir a quantidade de Dias consumida por Semana é Obrigatório.")]
        [Range(1, 7, ErrorMessage = "Valor deve estar entre 1 e 7")]
        public int DiasPorSemana { get; set; }
        [Required(ErrorMessage = "definir a quantidade de Horas consumida por dia é Obrigatório.")]
        ...
        public TipoTransacaoFinanceira TipoTransacaoFinanceira { get; set; } = TipoTransacaoFinanceira.Despesa;
        [Required]
